...
void dTables::Ok()
{
    ...
    {
        pszCatalog = stringCatalog.toUtf8().constData();
    ...
    {
        pszSchema = stringSchema.toUtf8().constData();
    ...
    {
        pszTable = stringTable.toUtf8().constData();
    ...
    {
        pszType = stringType.toUtf8().constData();
...
void dColumns::Ok()
{
    ...
    cat = qcat.toUtf8().constData();
    sch = qsch.toUtf8().constData();
    tab = qtab.toUtf8().constData();
    col = qcol.toUtf8().constData();
    lcat = qlcat.toUtf8().constData();
    lsch = qlsch.toUtf8().constData();
    ltab = qltab.toUtf8().constData();
    lcol = qlcol.toUtf8().constData();
...
void dForeignKeys::Ok()
{
    ...
    lsch = qlsch.toUtf8().constData();
    ltab = qltab.toUtf8().constData();
    fk_cat = qfk_cat.toUtf8().constData();
    fk_sch = qfk_sch.toUtf8().constData();
    fk_tab = qfk_tab.toUtf8().constData();
    fk_lcat = qfk_lcat.toUtf8().constData();
    fk_lsch = qfk_lsch.toUtf8().constData();
    fk_ltab = qfk_ltab.toUtf8().constData();
