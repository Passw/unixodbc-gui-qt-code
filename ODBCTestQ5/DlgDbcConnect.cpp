...
/* printf( "[PAH][%s][%d][%s] [%s][%d][%s][%d][%s][%d]\n", __FILE__, __LINE__, __FUNCTION__,
                                    (SQLCHAR*)stringServer.toUtf8().data(), stringServerLength.toInt(),
                                    (SQLCHAR*)stringUser.toUtf8().data(), stringUserLength.toInt(), 
                                    (SQLCHAR*)stringAuthentication.toUtf8().data(), stringAuthenticationLength.toInt() ); */
    // do it...
